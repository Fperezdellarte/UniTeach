  ...
  const testimonials = [
    {
      name: "Juan Pérez",
      quote:
        "Gracias a Uniteach, he mejorado mis habilidades en matemáticas y ahora estoy más confiado para mis exámenes.",
    },
    {
      name: "María Gutiérrez",
      quote:
        "Encontré a un excelente mentor de programación que me ayudó a entender conceptos difíciles de una manera clara y sencilla.",
    },
    {
      name: "Carlos Paez",
      quote:
        "Una de las mejores herramientas para el aprendizaje de manera versátil.",
    },
  ];
        ...
        <Row>
          ...
          <Col md={6}>
            <div className="about fw-bold">
              ...
              <p className="text-white">
                Somos Uniteach, una plataforma creada por estudiantes que
                conecta a otros estudiantes universitarios para ofrecer y
                recibir mentorías académicas.
              </p>
              <p className="text-white">
                Nuestra misión es facilitar el intercambio de conocimientos y
                promover el éxito académico de nuestros usuarios.
              </p>
            </div>
          </Col>
          ...
          <Col md={6}>
            <div className="contact fw-bold">
              ...
              <Button onClick={handleFeedbackClick} className="blue-button">
                Enviar Mensaje
              </Button>
            </div>
          </Col>
